...
public class PerDetailActivity extends BaseActivity {
    ...
    public void initViews() {
        ...
        LineChart chart2 = (LineChart) findViewById(R.id.chart2_per_de);

        // 制作7个数据点（沿x坐标轴）
        LineData mLineData = makeLineData(7);
        setChartStyle(chart, mLineData, Color.WHITE);
        // 制作7个数据点（沿x坐标轴）
        LineData mLineData2 = makeLineData2(7);
        setChartStyle2(chart2, mLineData2, Color.WHITE);
    ...
    // 设置chart显示的样式
    private void setChartStyle2(LineChart mLineChart, LineData lineData, int color) {
        // 是否在折线图上添加边框
        mLineChart.setDrawBorders(false);

        mLineChart.setDescription("寄件数量");// 数据描述
...
//			}
     ...
     * @return
     */
    private LineData makeLineData2(int count) {
...
//        }
        ...
        // y轴数据集
        LineDataSet mLineDataSet = new LineDataSet(y, "员工一周寄件数量折线图");
